                                    ...
                                    <div class="table-responsive">
                                         <table class="table pos datatable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><a href="<?php echo base_url(); ?>pos/details/<?php echo $list->id;?>" title="DETAIL"><?php echo strtoupper($list->name); ?></a></td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group-">
                                                            ...
                                                            <a  href="<?php echo base_url(); ?>pos/details/<?php echo $list->id;?>" style="margin-right: 5px" class="btn btn-info pull-left-"  title="DETAIL" data-toggle="tooltip">Detail</a>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <?php $i++;} ?>
