                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                 <!--    <div class="table-responsive"> -->
                                         <table class="table  table-hover size" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>SN</th>
                                                    <th>HEIGHT</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?php echo $i; ?></td>
                                                    <td><?php echo strtoupper($list->height); ?></td>
                                                    <td><?php echo strtoupper($list->width); ?></td>
                                                    <td>
                                                        <div class="btn-group-">
                                                            <a  href="<?php echo base_url(); ?>pos/edit_size/<?php echo $list->id; ?>" class="btn btn-primary"  title="Edit" data-toggle="tooltip">Edit</a>
