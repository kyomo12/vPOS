                    ...
                    <div class="col-md-8">
                        ...
                        <div class="page-content-wrap">
                            ...
                            <div class="panel-heading">
                                    <h3 class="panel-title">UPDATE MATERIALS</h3>
                                ...
                                <div class="login-v1">
                                    ...
                                    <div class="login-box animated fadeInDown">
                                        <div class="login-body" id="loginContainer">
                                            ...
                                            <form action="<?php echo base_url(); ?>pos/edit_material" class="form-horizontal" method="POST" role="form">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <div class=" no-padding-left no-padding-right">
                                                        <div class="input-group">
                                                            ...
                                                            <input required type="text" class="form-control" name="name" value="<?php echo $list->name; ?>" placeholder="Material Name "/>
                                                        </div>
                                                    </div>
                                                </div>
                                              ...
                                              <div class="form-group col-md-8">
                                                    <div class="no-padding-left no-padding-right">
                                                        <div class="input-group">
                                                            ...
                                                            <textarea class="form-control" name="description" placeholder="Description"><?php echo $list->description; ?></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
