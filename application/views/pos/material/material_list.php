                        ...
                        <div class="col-md-8">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h3 class="panel-title">POS  MATERIALS</h3>
                                ...
                                <div class="panel-body">
                                 <!--    <div class="table-responsive"> -->
                                         <table class="table  table-hover material" width="100%">
                                            <thead>
                                                <tr>
                                                    <th>SN</th>
                                                    <th>NAME</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo strtoupper($list->description); ?></td>
                                                    <td>
                                                        <div class="btn-group-">
                                                            <a  href="<?php echo base_url(); ?>pos/edit_material/<?php echo $list->id; ?>" class="btn btn-primary"  title="Edit" data-toggle="tooltip">Edit</a>
